...
<section class="relative bg-ndi-blue text-white py-16">
    <div class="container mx-auto px-4 relative z-10 text-center">
        <span class="inline-block py-1 px-3 rounded-full bg-ndi-lime text-ndi-blue font-bold text-sm mb-4 tracking-wider animate-pulse">
            URGENCE NUMÉRIQUE
        </span>
        ...
        <a href="#simulation" class="inline-flex items-center gap-2 bg-white text-ndi-blue font-bold font-montserrat px-6 py-3 rounded-full hover:bg-ndi-lime hover:scale-105 transition shadow-[0_0_15px_rgba(255,255,255,0.3)]">
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="max-w-3xl mx-auto mb-10">
            ...
            <div class="w-full bg-gray-300 rounded-full h-3 overflow-hidden">
                <div id="gauge-bar" class="bg-gradient-to-r from-red-500 to-green-500 h-3 rounded-full transition-all duration-700" style="width: 5%"></div>
            </div>
        </div>

        <div class="flex flex-col md:flex-row gap-6 justify-center items-stretch min-h-[500px]">
            
            <div id="zone-proprio" class="drop-zone flex-1 bg-red-50 border-2 border-dashed border-red-200 rounded-xl p-6 flex flex-col items-center transition-all duration-300" data-type="proprio">
            ...
            <div class="w-full md:w-1/4 flex flex-col">
                <div id="items-panel" class="bg-white shadow-2xl rounded-xl p-6 flex flex-col items-center border border-gray-100 flex-grow relative overflow-hidden">
                    <div class="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-ndi-blue via-ndi-purple to-ndi-lime"></div>
                ...
                <div id="conclusion-panel" class="hidden bg-ndi-blue text-white shadow-2xl rounded-xl p-8 text-center animate-fade-in mt-4 border-2 border-ndi-lime">
                    ...
                    <a href="{{ route('about') }}" class="inline-block w-full bg-ndi-lime text-ndi-blue font-bold py-3 rounded hover:bg-white transition uppercase text-sm tracking-wider">
                        Voir les statistiques choc
                    </a>
                </div>
            </div>

            <div id="zone-libre" class="drop-zone flex-1 bg-blue-50 border-2 border-dashed border-ndi-blue rounded-xl p-6 flex flex-col items-center transition-all duration-300" data-type="libre">
                <div class="mb-6 text-center opacity-70">
...
<div id="info-modal" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-80 hidden backdrop-blur-sm transition-opacity">
    <div class="bg-white rounded-lg shadow-2xl w-full max-w-md mx-4 overflow-hidden border-t-8 border-yellow-400 transform scale-100 animate-bounce-short">
        
        <div class="bg-yellow-50 px-6 py-4 flex items-center gap-4 border-b border-yellow-100">
            <div class="bg-yellow-400 text-white rounded-full w-10 h-10 flex items-center justify-center flex-shrink-0 text-xl font-bold">!</div>
        ...
        <div class="p-8">
            ...
            <button onclick="closeModal()" class="w-full bg-gray-900 text-white py-3 rounded hover:bg-black transition font-bold text-sm tracking-wide uppercase">
...
<section class="py-20 bg-white border-t border-gray-200">
    <div class="container mx-auto px-4">
        ...
        <div class="grid md:grid-cols-3 gap-8">
            ...
            <div class="bg-gray-50 rounded-xl p-8 border border-gray-100 hover:shadow-xl transition duration-300 group">
                <div class="flex justify-between items-start mb-6">
                    ...
                    <span class="text-xs font-bold bg-green-100 text-green-700 px-2 py-1 rounded uppercase">Durable</span>
                </div>
                
                <h3 class="font-bebas text-2xl text-gray-800 mb-2 group-hover:text-ndi-blue transition">L'APRÈS WINDOWS 10</h3>
                <p class="text-sm font-bold text-gray-500 mb-4 uppercase tracking-wide">La stratégie : GNU/Linux (Mint ou PrimTux)</p>
                
                <p class="text-gray-600 text-sm leading-relaxed mb-6">
                    Windows 11 exige des PC récents (TPM 2.0). Passer sous <strong>Linux Mint</strong> permet de conserver 100% du parc informatique actuel, même les machines de plus de 5 ans.
                </p>
            ...
            <div class="bg-gray-50 rounded-xl p-8 border border-gray-100 hover:shadow-xl transition duration-300 group">
                <div class="flex justify-between items-start mb-6">
                    ...
                    <span class="text-xs font-bold bg-orange-100 text-orange-700 px-2 py-1 rounded uppercase">Inclusif</span>
                </div>
                
                <h3 class="font-bebas text-2xl text-gray-800 mb-2 group-hover:text-orange-600 transition">FORMATS OUVERTS</h3>
                <p class="text-sm font-bold text-gray-500 mb-4 uppercase tracking-wide">La stratégie : LibreOffice</p>
                
                <p class="text-gray-600 text-sm leading-relaxed mb-6">
                    L'école ne doit pas former des clients Microsoft, mais des citoyens numériques. L'utilisation du format ouvert <strong>.ODF</strong> garantit que les élèves pourront relire leurs travaux dans 20 ans.
                </p>
            ...
            <div class="bg-gray-50 rounded-xl p-8 border border-gray-100 hover:shadow-xl transition duration-300 group">
                <div class="flex justify-between items-start mb-6">
                    ...
                    <span class="text-xs font-bold bg-purple-100 text-purple-700 px-2 py-1 rounded uppercase">Responsable</span>
                </div>
                
                <h3 class="font-bebas text-2xl text-gray-800 mb-2 group-hover:text-ndi-purple transition">DONNÉES SOUVERAINES</h3>
                <p class="text-sm font-bold text-gray-500 mb-4 uppercase tracking-wide">La stratégie : Nextcloud</p>
                
                <p class="text-gray-600 text-sm leading-relaxed mb-6">
                    Remplacer Google Drive par <strong>Nextcloud</strong> permet de garder les données des élèves sur le territoire, sous le contrôle exclusif de l'établissement, conformément au RGPD.
                </p>
        ...
        <div class="mt-16 grid md:grid-cols-2 gap-6">
            ...
            <div class="bg-blue-50 border-2 border-blue-200 rounded-xl p-8 relative overflow-hidden group hover:border-ndi-blue transition duration-300">
                <div class="absolute top-0 right-0 bg-blue-600 text-white text-xs font-bold px-3 py-1 rounded-bl uppercase">Officiel</div>
                ...
                <p class="text-sm text-gray-600 mb-6 leading-relaxed">
                    ...
                    Un ensemble d'outils libres, souverains et RGPD, hébergés par l'État, gratuits pour tous les enseignants et élèves.
                </p>
                ...
                <a href="https://apps.education.fr/" target="_blank" class="inline-flex items-center gap-2 text-blue-700 font-bold hover:gap-3 transition-all">
                    ACCÉDER À LA PLATEFORME <i class="fa-solid fa-arrow-right"></i>
                </a>
            </div>

            <div class="bg-purple-50 border-2 border-purple-200 rounded-xl p-8 relative overflow-hidden group hover:border-ndi-purple transition duration-300">
                <div class="absolute top-0 right-0 bg-purple-600 text-white text-xs font-bold px-3 py-1 rounded-bl uppercase">Culture Libre</div>
                ...
                <a href="https://framasoft.org" target="_blank" class="inline-flex items-center gap-2 text-purple-700 font-bold hover:gap-3 transition-all">
